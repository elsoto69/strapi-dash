...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isArticle: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
...
export interface ApiUserDatasUserDatas extends Struct.SingleTypeSchema {
  collectionName: 'user_data';
  info: {
    singularName: 'user-datas';
    pluralName: 'user-data';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::user-datas.user-datas': ApiUserDatasUserDatas;
